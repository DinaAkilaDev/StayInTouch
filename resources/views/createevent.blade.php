                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            <li>
                                <a href="{{url('/event/add')}}">New Event</a>
                    ...
                    <!-- END PAGE BAR -->
                    <!-- BEGIN PAGE TITLE-->
                    <h1 class="page-title"> Add New Event
                    </h1>
                    <div class="tab-pane" id="tab_2">
                        <div class="portlet box green">
                            ...
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <form  action="{{route('newevent')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="datetime-local" name="date" class="form-control" placeholder="Enter Event Date" required>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <textarea type="text" name="text" class="form-control" placeholder="Enter Event Message" required></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">
                                                        <input type="url" name="video" class="form-control" > </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
